       ...
       save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ConDet.isConnected()) {
                    ...
                    DatabaseReference current_user_db= FirebaseDatabase.getInstance().getReference().child("Users").child("Mechanics").child(Cust_Id);
                    current_user_db.child("Mobile number").setValue(phonenumber);
                    Toast toast=new Toast(getApplicationContext());
                    TextView tv= new TextView(phonenumedit.this);
                    tv.setBackgroundColor(Color.BLACK);
                    tv.setTextColor(Color.WHITE);
                    ...
                    tv.setTypeface(ty);
                    tv.setPadding(10,10,10,10);
                    tv.setText("Mobile nuber Updated");
                    toast.setView(tv);
                    toast.show();
                    timer = new Timer();
                    timer.schedule(new TimerTask() {
